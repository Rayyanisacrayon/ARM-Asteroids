...
SSIO_DR_R               EQU   0x40008008
SSIO_SR_R               EQU   0x4000800C
...
;6) If bit 4 is high, loop back to step 5 (wait for BUSY bit to be low)
	PUSH{R4-R8,LR}
b4high1	LDR R4, =SSIO_SR_R;
		LDR R4, [R4];
		AND R4, #0x10;
		CMP R4, #0 ;check bit 4 of status register
		BNE b4high1
